  ...
  return (
    <>
      ...
      {key.PD?(
        ...
        <div className="sale-carosel">
            <div className="sale-carosel-title">
                <div className="sale-title" style={{fontSize:"1.5em"}} >Customers Also Viewed</div>
            </div>
            <div>
                <Slider {...settings}>
                    {caroselImages.map((d) => (
                        <div key={Math.random()} className="sale-carosel-items">
                            <img src={d.img} alt="" />
                            <div className="carosel-sale-discriptions">{d.discription}</div>
                            <div className="carosel-sale-discriptions">{d.price}</div>
        ...
        <div className="sale-carosel">
            <div className="sale-carosel-title">
                <div className="sale-title" style={{fontSize:"1.5em"}} >Recommended Products</div>
            </div>
            <div>
                <Slider {...settings}>
                    {caroselImages.map((d) => (
